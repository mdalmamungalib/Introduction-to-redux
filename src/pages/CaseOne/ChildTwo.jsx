  ...
  return (
    <div className="p-5 text-white border border-orange-600 rounded-lg">
      ...
      <div className="flex items-center justify-center p-20 space-x-3">
        <button onClick={() => setCount((prev) => prev - 1)} className="text-white bg-red-500 btn hover:bg-red-400">
          Decrement
        </button>
        <h2>{count}</h2>
        <button onClick={() => setCount((prev) => prev + 1)} className="text-white bg-green-500 btn hover:bg-green-400">
          Increment
        </button>
      </div>
    </div>
